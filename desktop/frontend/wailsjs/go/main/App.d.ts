...
export function DisableAutoConnect(arg1:string):Promise<void>;
...
export function RequestAutoConnect(arg1:string):Promise<void>;

export function RequestConnection(arg1:string,arg2:string):Promise<models.ConnectionResponse>;

export function ResolveAutoConnect(arg1:string,arg2:boolean):Promise<void>;
